...
const About = (props: Props) => {
  return (
    <div id="about" className="md:px-20 px-10 md:py-10 py-5">
      ...
      <div className="flex md:flex-row flex-col gap-6 items-start">
        ...
        <div className="flex flex-col gap-3 md:w-1/2">
          <p className="text-gray font-normal text-lg">
            Ilé-Íwösàń is a platform where users can search for hosiptals in
          ...
          <p className="text-blue text-sm font-medium flex flex-row gap-3">
            View our services <ArrowRight color="#016FEB" size={20} />
          </p>
        </div>
      </div>
